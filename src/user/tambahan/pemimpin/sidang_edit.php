                ...
                <div class="panel-body">
                    ...
                    while($d = mysqli_fetch_array($data)){
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control" name="ruangan" required="required">
                                <option value="<?php echo $d['ruangan_sidang']; ?>">Pilih Ruangan</option>
                                <?php 
                                $kategori = mysqli_query($koneksi,"SELECT * FROM ruangan");
                                while($k = mysqli_fetch_array($kategori)){
                                    ?>
