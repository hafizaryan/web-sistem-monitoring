                ...
                <div class="panel-body">
                    ...
                    <form method="post" action="permohonan_aksi.php">
                        <div class="form-group">
                            ...
                            <input type="number" class="form-control" name="nik" required="required" autofocus maxlength="100" minlength="12">
                        </div>
                        <div class="form-group">
                            <label>Nama Pemohon</label>
                            <input type="text" class="form-control" name="nama_pemohon" required="required" autofocus maxlength="100">
                        </div>
                        <div class="form-group">
                            <label>Alamat Pemohon</label>
                            <input type="text" class="form-control" name="alamat_pemohon" required="required" autofocus>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control" name="no_registrasi" required="required"></textarea>
                        </div>
                        <div class="form-group">
                            <label></label>
